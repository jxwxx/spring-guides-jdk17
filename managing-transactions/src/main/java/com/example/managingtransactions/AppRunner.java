...
public class AppRunner implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Assert.isTrue(bookingService.findAll().size() == 3, "First booking should work with no problem");
        ...
        for (String person: bookingService.findAll()) {
        ...
        Assert.isTrue(bookingService.findAll().size() == 3, "'Samuel' should have triggered a rollback");
        ...
        Assert.isTrue(bookingService.findAll().size() == 3,
